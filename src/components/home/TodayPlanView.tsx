  ...
  return (
    <>
      <div className="mx-auto min-h-0 w-full max-w-[430px] flex-1 space-y-5 overflow-y-auto px-4 py-4 pb-28">
        <div>
          <h2 className="text-foreground text-lg font-semibold">Thực đơn hôm nay</h2>
        ...
        <div className="space-y-2">
          <p className="text-foreground text-sm font-medium">Các bữa</p>
          {apiSlots.map((slot) => {
            ...
            return (
              <Link
                ...
                className="border-border hover:bg-muted/50 block rounded-xl border p-3 text-left text-sm"
              >
